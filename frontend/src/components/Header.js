...
function Header() {
  return (
    <header>
      <Container className="headerContent" py-5 fluid>
        <Nav className="navMenu">
          <Navbar.Brand className="brandImage" href="#home">
            <svg
              width="24"
              height="22"
              viewBox="0 0 24 22"
          ...
          <Nav.Item className="navScheduleBtn">
            <Nav.Link href="/home">
              <button size="lg" className="scheduleBtn" type="button">
                Start Scheduling
              </button>
            </Nav.Link>
          </Nav.Item>
